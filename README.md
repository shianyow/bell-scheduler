...
### 核心設計模式
- **MVC 架構**：清楚分離路由、API 邏輯和工具函式
- **RESTful API**：標準化的 API 設計
- **響應式設計**：適應不同螢幕尺寸
- **錯誤處理**：完整的錯誤捕捉和使用者友善的錯誤訊息
...
**Q: 系統狀態檢查失敗？**
A: 確認 SystemConfig 工作表存在且包含必要的配置項目。

**Q: 測試介面無法載入？**
A: 確認 `test.html` 檔案已正確上傳到 Google Apps Script 專案中。
